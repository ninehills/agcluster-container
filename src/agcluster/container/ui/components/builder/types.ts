...
export const TOOL_METADATA: Record<string, ToolMetadata> = {
  ...
  KillShell: { name: 'KillShell', description: 'Kill background shell', category: 'shell' },
  Skill: { name: 'Skill', description: 'Execute MCP skill', category: 'mcp' },
  SlashCommand: { name: 'SlashCommand', description: 'Execute MCP slash command', category: 'mcp' },
